...
### Added
* Support to configure 49 multiple interfaces for vrf_lite on a vrf
* Added support for more switch roles in inventory module.
* Change 3
...
### Added
* Support to configure 40 multiple interfaces for vrf_lite on a vrf
* Added support for more switch roles in inventory module.
* Change 3
...
[3.30.50]: https://github.com/CiscoDevNet/ansible-dcnm/compare/3.30.49...3.30.50
[3.30.49]: https://github.com/CiscoDevNet/ansible-dcnm/compare/3.30.40...3.30.49
[3.30.40]: https://github.com/CiscoDevNet/ansible-dcnm/compare/3.3.0...3.30.40
